...
![Java内存模型抽象示意图](/Java/MemoryModel/IMG/01.png)
...
![通信示意图](/Java/MemoryModel/IMG/01.png)
...
![Java源代码重排序](/Java/MemoryModel/IMG/03.png)
...
![示例图](/Java/MemoryModel/IMG/04.png)

假设处理器 A 和处理器 B 按程序的顺序并行执行内存访问，最终却可能得到 **x = y = 0** 的结果。具体的原因如下图所示：

![示例图](/Java/MemoryModel/IMG/05.png)
...
![示例图](/Java/MemoryModel/IMG/06.png)

上表单元格的"N"表示处理器不允许两个操作重排序，"Y"表示允许重排序。
...
![示例图](/Java/MemoryModel/IMG/07.png)
